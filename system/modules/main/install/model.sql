...
INSERT INTO `{{setting}}` (`skey`, `svalue`) VALUES ('attachsize', '10');
INSERT INTO `{{setting}}` (`skey`, `svalue`) VALUES ('filetype', 'csv, chm, pdf, zip, rar, tar, gz, bzip2, gif, jpg, jpeg, png, txt, doc, xls, ppt, docx, xlsx, pptx, htm, html');
...
INSERT INTO `{{setting}}` (`skey`, `svalue`) VALUES ('skin', 'white');
...
INSERT INTO `{{setting}}` (`skey`, `svalue`) VALUES ('version','4.5.5 open');
