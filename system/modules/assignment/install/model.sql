...
CREATE TABLE IF NOT EXISTS `{{assignment}}` (
	...
	`associatedmodule` varchar(30) NOT NULL DEFAULT '' COMMENT '关联模块',
  `associatednode` varchar(50) NOT NULL DEFAULT '' COMMENT '关联节点',
  `associatedid` varchar(60) NOT NULL DEFAULT '' COMMENT '关联id',
